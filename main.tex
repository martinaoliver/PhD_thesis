...
\usepackage[bibstyle=numeric,style=authoryear-icomp,maxbibnames=9,maxcitenames=2,uniquelist=false, backend=bibtex,url=false]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
