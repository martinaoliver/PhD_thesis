...
\usepackage[bibstyle=numeric,style=authoryear-icomp,maxbibnames=10,maxcitenames=2,uniquelist=false, backend=bibtex,url=false]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\newacronym{SALI}{SALI}{short-range activation and long-range inhibition}
...
\supervisor{Prof. Robert G. Endres \\ Prof. Mark Isalan } % print with \supname
\examiner{Prof. Eamonn A. Gaffney \\ Dr. Jose Jimenez Zarco} % TODO print with \examname
...
%----------------------------------------------------------------------------------------
    ...
    Data-driven modelling of robust Turing patterns in synthetic biofilms © 2024 by Martina Oliver Huidobro is licensed under Attribution-NonCommercial 4.0 International
    %----------------------------------------------------------------------------------------
%	Commands
%----------------------------------------------------------------------------------------
