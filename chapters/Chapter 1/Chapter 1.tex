...
\begin{figure}
    \centering
    % TODO si les quito el comentario a estas crashea.. asi que el comando debe de estar mal. Usa otra manera de hacer esto, o sino lo vemos juntos luego!
%    \subfigure[]{\includegraphics[width=0.45\linewidth]{chapters/Chapter 1/multistability1}}
%    \subfigure[]{\includegraphics[width=0.45\linewidth]{chapters/Chapter 1/multistability2}}
%    \subfigure[]{\includegraphics[width=0.45\linewidth]{chapters/Chapter 1/multistability3}}
