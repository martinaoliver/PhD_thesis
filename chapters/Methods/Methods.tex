...
\subsubsection{Introducing Dirilichet or absorbing boundary conditions}\label{methods_boundary_conditions_CN}
CN method can be implemented with Neumann no-flux boundary conditions or Dirilichet absorbing boundary conditions.
...
Similarly, Dirilichet absorbing boundary conditions represented by the following system
...
\subsubsection{Introducing Dirilichet or absorbing boundary conditions}\label{methods_boundary_conditions_ADI}
As with the CN method, ADI can also be implemented with Neumann no-flux boundary conditions or Dirilichet absorbing boundary conditions.
