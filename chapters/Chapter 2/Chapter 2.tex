...
Mathematically, to ensure a transfer function XY is matched, the $K^*_{XY}$ of the dose response 2 producing Y needs to be within the dynamic range of the dose response 1 producing X as seen in Figure X.%TODO create figure
...
Transfer function matching yielded a well-functioning circuit (Fig. 1b) with a better capacity to produce spatial patterns as seen. %TODO ref adaapted figure paper.
