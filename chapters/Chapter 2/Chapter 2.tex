...
\begin{figure}[H] % h! is a placement specifier; it tries to place the image here.
    ...
    \end{adjustbox}
    \caption{\textbf{Fitted OC\subscript{14} dose-response curves
...
From this comparison, we aimed to obtain a distribution of model parameters that fitted the experimental data with a certain level of uncertainty.
