...
The enzymatic production of the diffusers was modelled with a simple linear production term dependent on synthesis enzyme concentration
([A], [B]),
and a rate constant
($K_{1}$ and $K_{2}$).
...
\begin{figure}[H] % h! is a placement specifier; it tries to place the image here.
    ...
    n is ignored because they are fixed.}%TODO fact check}
...
In terms of the tuning molecules (IPTG, ATC and DAPG)
...
%TODO comment Experimentally, no patterns were observed with a high DAPG concentration (Fig. S16),
...
to measure concentration at these points %TODO ref figure fits(Fig. S20).
